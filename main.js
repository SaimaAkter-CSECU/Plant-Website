...
sr.reveal('.home__data, .about__top, .popular__top, .review__top, .review__swiper, .footer__icon, .footer__content, .footer__flora, .copy__right')
sr.reveal('.home__image', {delay: 400, scale: 0.5})
...
sr.reveal('.review__leaf, .footer__flora', {delay: 1000, origin: "left"}) 
